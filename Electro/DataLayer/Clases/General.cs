    ...
    public class General
    {
        ...
        public static QueryString EncryptQueryString(QueryString queryString)
        {
            ...
            foreach (string name in queryString)
            {
                ...
                newQueryString.Add(General.Encrypt(nm, "%jetsbdh"), General.Encrypt(val, "%jetsbdh"));
            }
        ...
        public static QueryString DecryptQueryString(QueryString queryString)
        {
            ...
            foreach (string name in queryString)
            {
                if(name != "fbclid")
                {
                    nm = General.DecryptString(name, "%jetsbdh");
                    val = System.Web.HttpUtility.UrlDecode(General.DecryptString(queryString[name], "%jetsbdh"));
